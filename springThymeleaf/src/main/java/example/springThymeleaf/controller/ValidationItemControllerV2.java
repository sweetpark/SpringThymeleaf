...
public class ValidationItemControllerV2 {
    ...
    //BindingResult는 @ModelAttribute 바로 뒤에 위치시켜야함
//    @PostMapping("add")
    ...
    //errors.properties 사용 (field-error detail)
    //@PostMapping("add")
    ...
    //errors.properties 사용 + reject method 사용
    //@PostMapping("add")
...
//    @PostMapping("add")
    ...
    @PostMapping("add")
    public String addItem5(@Validated @ModelAttribute Item item, BindingResult bindingResult, RedirectAttributes redirectAttributes){
